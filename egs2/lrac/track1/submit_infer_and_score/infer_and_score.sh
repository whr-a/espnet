...
# --- Script Paths ---
INFER_SCRIPT="/work/nvme/bbjs/hwang41/lrac/espnet/egs2/lrac/track1/submit_infer_and_score/infer.sh"
SCORE_SCRIPT="/work/nvme/bbjs/hwang41/lrac/espnet/egs2/lrac/track1/submit_infer_and_score/score.sh"
