# Copyright 2024 Jiatong Shi (Modified for paired data)
# Apache 2.0  (http://www.apache.org/licenses/LICENSE-2.0)

"""GAN-based neural codec task with clean-noisy paired data."""
...
from espnet2.gan_codec.espnet_model_paired import ESPnetGANCodecModelPaired
from espnet2.gan_codec.funcodec.funcodec import FunCodec
from espnet2.gan_codec.lracodec_paired.lracodec_paired import LRACodecPaired
...
codec_choices = ClassChoices(
    ...
    classes=dict(
        ...
        dac=DAC,
        funcodec=FunCodec,
        lracodec_paired=LRACodecPaired,
    ),
    default="lracodec_paired",
)


class GANCodecPairedTask(AbsTask):
    """GAN-based neural codec task with clean-noisy paired data."""
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetGANCodecModelPaired),
        ...
        group.add_argument(
            ...
            type=str2bool,
            default=True,
            help="Use clean-noisy paired data for training",
        )
    ...
    def build_preprocess_fn(
        ...
        if args.use_preprocessor:
            ...
            retval = CommonPreprocessor(
                ...
                speech_name="audio",  # This will be the clean audio
    ...
    def required_data_names(
        ...
        if not inference:
            # For training, require both clean (audio) and noisy (audio_noisy)
            retval = ("audio", "audio_noisy")
        else:
            # For inference, only need the noisy audio
            retval = ("audio",)
        return retval
    ...
    def optional_data_names(
        ...
        if not inference:
            # audio_noisy is optional if not using paired data
            return ()
        return ()

    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetGANCodecModelPaired:
        ...
        # 2. Build model
        model = ESPnetGANCodecModelPaired(
            codec=codec,
            **args.model_conf,
        )
        return model
