...
class UniversaCollateFn(CommonCollateFn):
    ...
    def __init__(
        ...
        tmp_metrics = []
        with open('/work/nvme/bbjs/bsu5/universa/espnet/egs2/universa_unite/uni_versa1/metric2id_fix_1', 'r') as f:
            for line in f.readlines():
                tmp_metrics.append(line.split()[0])
        self.fix_order_metric_list = tmp_metrics
    ...
    def _create_metric_sequence_tensor(self, metrics_dict):
        ...
        if self.randomize:
            ...
            items = [
                ...
                for name in self.fix_order_metric_list
