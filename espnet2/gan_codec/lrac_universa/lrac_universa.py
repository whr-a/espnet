...
from espnet2.gan_codec.shared.loss.universa_ext_loss import universaLoss
...
class Lrac_universa(AbsGANCodec):
    """Lrac model."""
    ...
    def __init__(
        ...
        self.generator = Lrac_universaGenerator(
        ...
        self.discriminator = Lrac_universaDiscriminator(**discriminator_params)
    ...
    def _forward_generator(
        ...
        **kwargs,
        ...
        if self.use_universa_loss:
            universa_loss = self.universa_loss(audio_hat)
        ...
        if self.loss_balancer is not None and self.training:
            ...
            if self.use_universa_loss:
                balanced_losses.update(universa=universa_loss)
...
class Lrac_universaGenerator(nn.Module):
...
class Lrac_universaDiscriminator(torch.nn.Module):
