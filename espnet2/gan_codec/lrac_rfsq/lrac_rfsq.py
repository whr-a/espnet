...
from espnet2.gan_codec.shared.quantizer.rfsq import ResidualFSQ
...
class Lrac_rfsq(AbsGANCodec):
    ...
    def __init__(
        ...
        self.generator = Lrac_rfsqGenerator(
            sample_rate=sampling_rate,
            encoder_params=encoder_params,
            decoder_params=decoder_params,
            quantizer_params=quantizer_params,
        )
        self.discriminator = Lrac_rfsqDiscriminator(**discriminator_params)
...
class Lrac_rfsqGenerator(nn.Module):
...
class Lrac_rfsqDiscriminator(torch.nn.Module):
