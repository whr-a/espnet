...
from espnet2.gan_codec.shared.loss.arecho_score_loss import ArechoLoss
...
class Lrac_rewrite_arecho_score(AbsGANCodec):
    """Lrac model."""
    ...
    def _forward_generator(
        ...
        **kwargs,
        ...
        if self.use_arecho_loss:
            arecho_loss = self.arecho_score_loss(audio_hat)
